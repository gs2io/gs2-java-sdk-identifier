...
public class DescribeSecurityPolicyRequest extends Gs2BasicRequest<DescribeSecurityPolicyRequest> {
	 ...
	 * @return this
	 */
	public DescribeSecurityPolicyRequest withPageToken(String pageToken) {
	 ...
	 * @return this
	 */
	public DescribeSecurityPolicyRequest withLimit(Integer limit) {
		setLimit(limit);
		return this;
	}
}
